...
<li><label for="psw">Password</label>
  ...
  <li><label for="pass">Confirm Password</label>
      <input type="password" id="pass2" name="pass2" placeholder="Confirm Your Password.." onchange="check();" required></li><br>
               ...
               <li><center><input type="submit" value="SEND" name="submit" button class="button" onclick="f1()"></center></li>
               <li><center><input type="reset" value="RESET" onclick="javascript:document.forms.form1.reset()"></center></li>
           </ul>
           </fieldset>
