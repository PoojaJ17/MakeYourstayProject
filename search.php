...
<!--        <a href="#open-model1">Sign up</a>-->
        ...
        <div class="blocknew">
            ...
            <input type="text"id="place"name="place" placeholder="Destination">
            <input type="text"id="dt1" name="dt1"placeholder="Deparch Date">
            <input type="text"id="dt2"name="dt2" placeholder="Return Date">
            <select id="seat" name="seat">
                ...
                <option value="3">Person 3</option>
                 ...
                 <a href="Search.php"> <input type="button" id="search" value="Search" name="search"></a>              
...
-->
               ...
               $qu="SELECT * FROM `new_room_type` WHERE Address LIKE '%$des%'";
                $que_ru=mysqli_query($con,$que);
                
    
//                $r=mysqli_num_rows($que_run);
                while($r=mysqli_fetch_array($que_ru))
        ...
        <table width="95%">
                       <tr>
                        <td ><img src="<?php echo $img; ?>"height="250px"width="380px"></td>
                           <td  valign="top" ><b><font size="5" text-align=top><?php echo $r['roomname']; ?></font></b><br><br><br>
                               <span style="font-style:arial;font-size:98%;padding:8px 0px" ><?php echo $r['Address']; ?></span><br><br><br>
                       <b>Price-</b><?php echo $r['price']; ?></td>
                          <td ><button id="b2">ViewDetails</button></td>
                           <td valign="left"><button id="b1">Book</button></td>
