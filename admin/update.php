...
//                $que= mysqli_query($db,"Select *from new_room_type where id='$id'")or die(mysqli_error($db));   
//                 $que_run=mysqli_query($db,$que);
//                 $row =mysqli_fetch_array($que_run);
                 
                 $sql=mysqli_query($db,"UPDATE new_room_type SET roomname='$rname',description= '$desc',persons='$maxp',room= '$avail',price= '$price',image='$image_path' WHERE id='$id'")or die(mysqli_error($db));   
...
<script type="text/javascript">
    ...
    function f1()
    {
        alert("Hotel Rooms Updated Successfully..");
    }
        </script> 
...
-->
                         <br><br><br>
                    <div class="submit">
                    <li><input  name="submit" value="Update" id="submit" type="submit" onclick="f1()"></li>
